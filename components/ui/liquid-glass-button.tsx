      ...
      >
        ...
        <div
          ...
          style={{
            ...
            // Safari — including every browser on iOS — does not support SVG
            // filters in backdrop-filter, so the glass would render as plain
            // transparency. This keeps the material readable on the target
            // platform; browsers that support the filter above ignore it.
